...
main (a25cccb) — demo pública inmutable
 └── 924d316 — tag congelado farmacia-demo-lunes-stable-924d316
      └── work/farmacia-demo-lunes-plus-wo1-wo2-20260614 ← FUENTE DE TRABAJO ACTUAL
...
| **`work/farmacia-demo-lunes-plus-wo1-wo2-20260614`** | **`9201003`** | **Todo lo anterior consolidado: demo + WO1 + WO2 + WO2b-e** | **✅ Activa** | **✅ FUENTE DE TRABAJO ACTUAL** | **De aquí nace WO3** |
...
- Toda nueva WO debe nacer desde esta rama.
- WO3, cuando se lance, debe crear rama hija desde aquí.
- Esta rama NO debe contener cambios visuales de WO3, mapping, CIMA fuente, ni datos demo.
...
- WO3 no mergea a main. WO3 tampoco.
