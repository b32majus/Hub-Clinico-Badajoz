...
| Unified Clinical Intake V0 | parent #292 aprobado; T2 #294 completado con checkpoint remoto aceptado `2c6ec5741ce61373c8ed0ade6601b86d3df83228` (380/380 + Cora PASS; Gentle parcial 3/4 por fallo de transporte, sin ack/burn); frontier ejecutable: T1 #293, T3 #295 y T4 #296; T5–T10 siguen dependency-gated; merge NO autorizado; detalle en [`docs/ops/WORK_ORDER_STATUS.md`](/docs/ops/WORK_ORDER_STATUS.md) |
