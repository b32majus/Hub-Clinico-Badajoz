...
| Rama de rescate integrada | `origin/rescue/farmacia-v4`. Último HEAD funcional reconciliado: `6e920bb68d8796b9780c7daaf106fe80d14c7d78` (PR #116). La propia reconciliación documental puede avanzar posteriormente el HEAD sin añadir funcionalidad clínica. |
...
| Rama de trabajo de este índice | `work/docs/fh-followup-post-pr114-pr116-reconciliation-v4-20260726` |
...
| `origin/rescue/farmacia-v4` | Integración viva del rescate V4. Último HEAD funcional reconciliado: `6e920bb68d8796b9780c7daaf106fe80d14c7d78` (PR #116). La propia reconciliación documental puede avanzar posteriormente el HEAD sin añadir funcionalidad clínica. | S01–S08 cerrados en su alcance técnico previo; PR #114 integra contexto canónico y gate S09–S11 sobre `patient_id + line_id`, con líneas históricas visibles pero no elegibles y selección explícita multiactiva; PR #116 integra borradores por línea en `sessionStorage` versionado y fail-closed, restauración/separación exactas y guard S12 dentro de Seguimiento. | Estado publicado, demo-ready, piloto, producción, datos reales, backend o V5; registro clínico interno de Seguimiento (Morisky/adherencia, PROMs, DLQI/EVA, efectos adversos/causalidad, optimización o suspensión), exportaciones JARA/CSV/Excel de Seguimiento, dashboards canónicos, cierre completo S09–S12 o guard S12 transversal. |
...
| [`docs/ops/PLAN_MAESTRO_RESCATE_FARMACIA_V4_20260724.md`](/docs/ops/PLAN_MAESTRO_RESCATE_FARMACIA_V4_20260724.md) | Plan vivo reconciliado hasta PR #116 | Gobierno y estado del rescate V4, referencias, fases, dependencias, aptitud y trabajo restante. | Autorización automática de código, publicación, piloto, backend o V5. |
...
| Seguimiento V4 S09–S12 | Fase iniciada parcialmente | Contexto/gate S09–S11 y borradores/guard S12 integrados; capacidades clínicas y salidas pendientes. No están cerrados S09–S12 ni demostrado un guard S12 transversal fuera de Seguimiento. |
...
*Índice generado en el contexto de `WO-DOC-INDEX-CONTROL-PLANE-POST-SES-01-20260713`, reconciliado previamente hasta PR #106 por `WO-DOC-FH-RESCUE-STATUS-RECONCILIATION-V4-01`, actualizado hasta PR #110 por `WO-DOC-FH-POST-PR110-STATUS-RECONCILIATION-V4-01` y reconciliado hasta PR #116 por `WO-DOC-FH-FOLLOWUP-POST-PR114-PR116-RECONCILIATION-V4-01` (issue #117). No autoriza cambios de código, publicación, merges ni integraciones.*
