...
| Rama de rescate integrada | `origin/rescue/farmacia-v4`. Último HEAD funcional reconciliado: `2ad406e0fc14ce50a1bb3e9f898bab482591ddc6` (PR #140 / issue #139, completados). PR #138 / issue #137 completaron antes la reconciliación exclusivamente documental en `11b7ae642cc76c035ca42bdf386b86b77046f7eb`; no constituyó un HEAD funcional nuevo. |
...
| Rama de trabajo de este índice | `work/docs/fh-post-pr140-canonical-outputs-reconciliation-v4-20260726` |
...
| `origin/rescue/farmacia-v4` | Integración viva del rescate V4. Último HEAD funcional reconciliado: `2ad406e0fc14ce50a1bb3e9f898bab482591ddc6` (PR #140 / issue #139, completados). PR #138 / issue #137 fue la reconciliación exclusivamente documental `11b7ae642cc76c035ca42bdf386b86b77046f7eb`, no un HEAD funcional nuevo. | S01–S08 cerrados en su alcance técnico previo. PR #114–#136 integran el alcance parcial de Seguimiento hasta la visita demo confirmada. PR #140 añade tres salidas canónicas de revisión con la misma identidad de visita confirmada: TXT tipo JARA solo demo, no integración JARA real; CSV de una fila y exactamente 42 columnas; y fila Excel FH de exactamente 61 columnas. En cada ejecución relee contexto y stores; la única fuente clínica es la última visita confirmada exacta para `patient_id + line_id`, junto con contexto canónico activo explícito. Borrador, DOM, legacy, causalidad, decisiones y movimientos no son fuentes. Conserva ceros PROM y ausencia machine-readable vacía, MG1–MG4 crudos sin clasificación y EA explícito sin fármaco sospechoso, causalidad ni acción. Intercepta y deja inertes handlers legacy, preserva helpers globales y protege frente a fallos asíncronos y cambios de contexto en vuelo. Emite `farmacia:followup-confirmed-visit-v1` con payload mínimo no clínico. QA soportada cubre S09, S10, ambas líneas S11, S12, identidad, recarga, invariancia ante dirty inputs y fallos de helpers/storage, con consola/`pageerror` a cero. | Estado publicado, demo-ready, piloto, producción, datos reales, backend o V5. Las salidas no son firma clínica, validez legal, registro asistencial ni registro productivo. Siguen pendientes interpretación de adherencia/EA/PROMs; DLQI calculado; causalidad Naranjo/Karch-Lasagna; fármaco sospechoso, corrección o acción ante EA; respuesta, recomendaciones, alertas, umbrales y tendencias; switch/add-on/optimización/pausa/suspensión/reanudación/finalización y demás decisiones o movimientos terapéuticos; dashboards; cierre completo de Seguimiento/S09–S12; y guard S12 transversal fuera de Seguimiento. Legacy clínico, causalidad, movimientos y dashboards permanecen inertes. |
...
| [`docs/ops/PLAN_MAESTRO_RESCATE_FARMACIA_V4_20260724.md`](/docs/ops/PLAN_MAESTRO_RESCATE_FARMACIA_V4_20260724.md) | Plan vivo reconciliado hasta PR #140 | Gobierno y estado del rescate V4, referencias, fases, dependencias, aptitud y trabajo restante. | Autorización automática de código, publicación, piloto, backend o V5. |
...
| Seguimiento V4 S09–S12 | Fase iniciada parcialmente | Además del contexto/gate, borradores, capturas no interpretadas, revisión persistida y visita demo confirmada, PR #140 integra TXT tipo JARA solo para revisión demo —no integración JARA real—, CSV canónico de una fila/42 columnas y fila Excel FH/61 columnas. Los tres formatos releen contexto/stores en cada ejecución y usan exclusivamente la última visita confirmada exacta para `patient_id + line_id` más el contexto canónico activo explícito, con la misma identidad entre formatos; nunca borrador, DOM, legacy, causalidad, decisiones o movimientos. Preservan cero/ausencia, MG crudo y EA sin inferencias. QA soportada cubre S09, S10, ambas líneas S11, S12, identidad, recarga, dirty invariance y fallos de helpers/storage sin errores de consola/página. Las salidas no son firma clínica, validez legal, registro asistencial ni productivo. Siguen pendientes interpretación de adherencia/EA/PROMs, DLQI calculado, causalidad, sospecha/corrección/acción ante EA, respuesta/recomendaciones/alertas/umbrales/tendencias, decisiones y movimientos terapéuticos, dashboards, cierre completo de Seguimiento/S09–S12 y guard S12 transversal fuera de Seguimiento. Legacy clínico, causalidad, movimientos y dashboards permanecen inertes. |
| Dashboards V4 | Pendientes posteriores | No están reconstruidos contra la fuente canónica. |
| Publicación, release y freeze V4 | Pendientes separados | El último HEAD funcional reconciliado no está publicado ni congelado. La fuente Pages y la candidata permanecen en `2ee3b347...` mediante PR #86; PR #88–#140 no están acreditados en Pages y el estado actual no está acreditado como demo-ready, piloto ni producción. |
...
*Índice generado en el contexto de `WO-DOC-INDEX-CONTROL-PLANE-POST-SES-01-20260713`, reconciliado previamente hasta PR #106 por `WO-DOC-FH-RESCUE-STATUS-RECONCILIATION-V4-01`, actualizado hasta PR #110 por `WO-DOC-FH-POST-PR110-STATUS-RECONCILIATION-V4-01`, reconciliado hasta PR #116 por `WO-DOC-FH-FOLLOWUP-POST-PR114-PR116-RECONCILIATION-V4-01` (issue #117), hasta PR #120 por `WO-DOC-FH-POST-PR120-ADHERENCE-RECONCILIATION-V4-01` (PR #122 / issue #121, completados), hasta PR #124 por `WO-DOC-FH-POST-PR124-AE-RECONCILIATION-V4-01` (PR #126 / issue #125, completados), hasta PR #128 por `WO-DOC-FH-POST-PR128-PROMS-RECONCILIATION-V4-01` (PR #130 / issue #129, completados; merge documental, no HEAD funcional nuevo), hasta PR #132 por `WO-DOC-FH-POST-PR132-PERSISTED-REVIEW-RECONCILIATION-V4-01` (PR #134 / issue #133, completados; merge documental `7a9287129ace6b120430c24bbcb36ebd6f73c33f`, no HEAD funcional nuevo), hasta PR #136 por `WO-DOC-FH-POST-PR136-CONFIRMED-VISIT-RECONCILIATION-V4-01` (PR #138 / issue #137, completados; merge documental `11b7ae642cc76c035ca42bdf386b86b77046f7eb`, no HEAD funcional nuevo) y hasta PR #140 por la implementación funcional `WO-FH-FOLLOWUP-CANONICAL-OUTPUTS-V4-01` (issue #139, completada). La reconciliación actual `WO-DOC-FH-POST-PR140-CANONICAL-OUTPUTS-RECONCILIATION-V4-01` (issue #141) está `READY_FOR_CORA_REVIEW`, sin PR ni merge. No autoriza cambios de código, publicación, merges ni integraciones.*
