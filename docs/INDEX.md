...
| Unified Clinical Intake V0 | technical handoff `PASS`; parent #292 aprobado por la operadora; tickets #293–#302 `status:approved` + `ready-for-agent`; T1 #293 y T2 #294 = root frontier desbloqueada; T3–T10 dependency-gated; merge NO autorizado; detalle en [`docs/ops/WORK_ORDER_STATUS.md`](/docs/ops/WORK_ORDER_STATUS.md) |
