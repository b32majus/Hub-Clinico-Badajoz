...
**Foundation Bootstrap Train (TRAIN-NEXUS-BOOTSTRAP-01, #387):** primer train sobre la línea Nexus ejecutado en rama `work/nexus-bootstrap-01-387-20260924` desde `d160f966...`: norma documental/handover ([`engineering/PRODUCT_DOCUMENTATION_STANDARD.md`](engineering/PRODUCT_DOCUMENTATION_STANDARD.md)), tooling reproducible Node 20 ([`engineering/TOOLING_BASELINE.md`](engineering/TOOLING_BASELINE.md)), deployment contracts v0 (#384), readiness/navigation contract v0 (#385) y primer oracle de lectura Reuma con clasificación `KNOWN_LEGACY` ([`engineering/REUMA_READ_CHARACTERIZATION.md`](engineering/REUMA_READ_CHARACTERIZATION.md)). Estado: PR final abierta contra `promueve/nexus-v4`; **merge no autorizado**; desbloquea F1.2/F1.3B y PlatformContext + Home.
