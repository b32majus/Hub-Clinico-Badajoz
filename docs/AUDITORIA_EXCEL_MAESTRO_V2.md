...
> El contrato operativo actual es `docs/CONTRATO_DATOS_REUMA_V2.md` y `docs/ORDEN_COLUMNAS_EXCEL_REUMA_V2.md`: 5 hojas clínicas, 497 columnas, prebiológico embebido por visita y Solicitud FH derivada no persistida.
