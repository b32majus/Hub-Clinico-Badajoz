...
`NEXUS-DEBT-001`, `NEXUS-DEBT-002` y `NEXUS-DEBT-006` están RESOLVED dentro de TRAIN-NEXUS-FOUNDATION-02 (#399), publicado por PR #400. Permanecen abiertos `NEXUS-DEBT-004`, los subhallazgos restantes de `NEXUS-DEBT-005`, `NEXUS-DEBT-007` y `NEXUS-DEBT-008`. D7 no bloquea F3.2 Home porque el corpus completo sigue verificando las 497 columnas; debe cerrarse antes del strangler/hardening de export Reuma. D8 no abre un fail-open runtime porque `ConfigurationRepository.load` ya rechaza rutas duplicadas; debe adelantarse al builder antes de F3.4 / synthetic Home release o antes si el builder se convierte en frontera de publicación. Cualquier implementación futura requiere WO explícita.
